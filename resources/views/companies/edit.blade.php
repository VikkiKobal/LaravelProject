...
<h1 class="text-3xl font-semibold mb-6">Edit Company</h1>
...
<form action="{{ route('companies.update', $company->id) }}" method="POST" class="bg-white p-6 rounded shadow-lg max-w-lg mx-auto">
    ...
    <div class="mb-4">
        <label for="employees" class="block text-lg font-medium text-gray-700">Employees</label>
    ...
    <div class="mb-4">
        <label for="industry" class="block text-lg font-medium text-gray-700">Industry</label>
    ...
    <button type="submit" class="bg-blue-500 text-white p-2 rounded w-full hover:bg-blue-600 transition duration-300">Update</button>
</form>
